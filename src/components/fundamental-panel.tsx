...
export function FundamentalPanel({ fundamentals, loading }: FundamentalPanelProps) {
  ...
  const items = [
    ...
    { label: 'Gross Profit', value: fundamentals.grossProfits ? formatMarketCap(fundamentals.grossProfits) : 'N/A' },
    ...
    { label: 'Market Cap', value: fundamentals.marketCapitalizationMktCap ? formatMarketCap(fundamentals.marketCapitalizationMktCap) : 'N/A' },
